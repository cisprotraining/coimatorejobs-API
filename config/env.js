...
export const { PORT = '5000', NODE_ENV, DB_URI, JWT_SECRET, JWT_EXPIRES_IN, EMAIL_USER, EMAIL_PASS, SUPERADMIN_EMAIL, FRONTEND_URL, MAIL_FROM_EMAIL, RESEND_API_KEY, THROTTLING_RETRY_DELAY_BASE = 1000 } = process.env;