...
employerRouter.get('/hr-admin-dashboard/reports/monthly-performance', authenticate, authorize(['hr-admin', 'superadmin']), hrAdminDashboardController.getMonthlyPerformanceReport);
